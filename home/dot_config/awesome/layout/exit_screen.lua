...
awful.keyboard.append_global_keybindings {
  awful.key({ modkey, "Mod1" }, "n", function()
    awesome.emit_signal("layout::exit_screen::show", true)
  end, { description = "exit", group = "power" }),
}
awful.keyboard.append_global_keybindings {
  awful.key({ modkey, "Mod1" }, "m", function()
    awesome.emit_signal("layout::exit_screen::hide", true)
  end, { description = "hide exit", group = "power" }),
}
